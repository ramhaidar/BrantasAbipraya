...
@section('title', 'Detail RKB Urgent - ' . $rkb->proyek->nama)
                ...
                <div class="ibox">
                    <div class="ibox-head pe-0 ps-0">
                        <div class="ibox-title d-flex align-items-center gap-3">
                            <a class="btn btn-outline-primary btn-sm btn-hide-text-mobile" href="{{ route('rkb_urgent.index') }}">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a class="btn btn-warning btn-sm btn-hide-text-mobile {{ $rkb->is_finalized ? '' : 'disabled' }}" href="{{ route('export.detail_rkb_urgent', ['id' => $rkb->id]) }}">
                    ...
                    <div class="p-0 m-0 py-3">
                        ...
                        @include('dashboard.rkb.urgent.detail.partials.table', [
                            'TableData' => $TableData,
                        ])
