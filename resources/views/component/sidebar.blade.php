...
<body class="layout-fixed sidebar-mini" data-panel-auto-height-mode="height" style="height:auto">
    <div class="wrapper">
        ...
        <aside class="elevation-4 main-sidebar sidebar-dark-primary" style="background-color: #212529">
            <a class="brand-link ms-0 ps-0 container-fluid pt-3">
                <img class="brand-image elevation-3 img-circle" src="/favicon.ico" alt="Abipraya Logo"
                    style="opacity:.8">
            ...
            @auth
                <div class="user-panel ms-0 ps-0 py-2 d-flex collapse-user-panel justify-content-start align-items-center">
                    <div class="image me-2">
                        <img class="img-circle elevation-2"
                            src="{{ Auth::user()->path_profile ?? 'dist/img/user2-160x160.jpg' }}" alt="User Image"
                            style="border-radius: 50%; width: 40px; height: 40px; border: 2pt solid #fff;">
                    </div>
                    <div class="info">
                ...
                <div class="form-inline mt-0 mx-0">
                    <div class="input-group" data-widget="sidebar-search">
                        <input class="form-control form-control-sidebar" id="searchProyek" type="search"
            ...
            <div class="sidebar m-0 p-0">
                <div class="scrollable-sidebar p-0 m-0">
                    <div
                        class="os-host os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition os-theme-light sidebar">
                        ...
                        <div class="os-padding mb-5" style="background-color: #343a40">
                            <div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y:scroll">
                                <div class="os-content" style="padding:0 8px;height:100%;width:100%">
                                    <nav class="mt-2">
                                        <ul class="nav flex-column nav-pills nav-sidebar" data-accordion="false"
                                            ...
                                            <li class="nav-item proyek-item">
                                                <a class="nav-link" data-bs-toggle="collapse"
                                                    data-bs-target="#subMenuMasterData" href="#"
                                                    aria-expanded="false">
                                                ...
                                                <ul class="collapse nav flex-column ms-1"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="{{ route('alat') }}">
                                                            <i
                                                                class="bi me-2 nav-icon fs-5 bi-gear-wide-connected"></i>
                                            ...
                                            @foreach ($proyeks as $item)
                                                <li class="nav-item proyek-item">
                                                    <a class="nav-link" data-bs-toggle="collapse"
                                                        data-bs-target="#subMenuProyek_{{ $item->id }}"
                                                    ...
                                                    <ul class="collapse nav flex-column ms-1"
                                                        id="subMenuProyek_{{ $item->id }}">
                                                        <li class="nav-item">
                                                            <a class="nav-link submenu" data-bs-toggle="collapse"
                                                                data-bs-target="#subMenuATB_{{ $item->id }}"
                                                                href="#" aria-expanded="false">
                                                                <i
                                                                    class="bi me-2 nav-icon fs-5 bi-calendar-week-fill"></i>
                                                                <p>ATB <i class="bi bi-caret-right-fill right"></i></p>
                                                            </a>
                                                            <ul class="collapse nav flex-column ms-3"
                                                                id="subMenuATB_{{ $item->id }}">
                                                                <li class="nav-item">
                                                                    <a class="nav-link"
                                                                        href="{{ route('atb_hutang_unit_alat', ['id_proyek' => $item->id]) }}">
                                                                        <i
                                                                            class="bi me-2 nav-icon fs-5 bi-calendar-week-fill"></i>
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link"
                                                                        href="{{ route('atb_panjar_unit_alat', ['id_proyek' => $item->id]) }}">
                                                                        <i
                                                                            class="bi me-2 nav-icon fs-5 bi-calendar-week-fill"></i>
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link"
                                                                        href="{{ route('atb_mutasi_proyek', ['id_proyek' => $item->id]) }}">
                                                                        <i
                                                                            class="bi me-2 nav-icon fs-5 bi-calendar-week-fill"></i>
                                                                        <p>Mutasi Proyek</p>
                                                                    </a>
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link"
                                                                        href="{{ route('atb_panjar_proyek', ['id_proyek' => $item->id]) }}">
                                                                        <i
                                                                            class="bi me-2 nav-icon fs-5 bi-calendar-week-fill"></i>
                                                                        <p>Panjar Proyek</p>
                                                                    </a>
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link submenu" data-bs-toggle="collapse"
                                                                data-bs-target="#subMenuAPB_{{ $item->id }}"
                                                                href="#" aria-expanded="false">
                                                                <i
                                                                    class="bi me-2 nav-icon fs-5 bi-calendar-range-fill"></i>
                                                                <p>APB <i class="bi bi-caret-right-fill right"></i></p>
                                                            </a>
                                                            <ul class="collapse nav flex-column ms-3"
                                                                id="subMenuAPB_{{ $item->id }}">
                                                                <li class="nav-item">
                                                                    <a class="nav-link"
                                                                        href="{{ route('apb_ex_unit_alat', ['id_proyek' => $item->id]) }}">
                                                                        <i
                                                                            class="bi me-2 nav-icon fs-5 bi-calendar-range-fill"></i>
                                                                        <p>EX Unit Alat</p>
                                                                    </a>
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link"
                                                                        href="{{ route('apb_ex_panjar_unit_alat', ['id_proyek' => $item->id]) }}">
                                                                        <i
                                                                            class="bi me-2 nav-icon fs-5 bi-calendar-range-fill"></i>
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link"
                                                                        href="{{ route('apb_ex_mutasi_saldo', ['id_proyek' => $item->id]) }}">
                                                                        <i
                                                                            class="bi me-2 nav-icon fs-5 bi-calendar-range-fill"></i>
                                                                        <p>EX Mutasi Saldo</p>
                                                                    </a>
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link"
                                                                        href="{{ route('apb_ex_panjar_proyek', ['id_proyek' => $item->id]) }}">
                                                                        <i
                                                                            class="bi me-2 nav-icon fs-5 bi-calendar-range-fill"></i>
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link submenu" data-bs-toggle="collapse"
                                                                data-bs-target="#subMenuSaldo_{{ $item->id }}"
                                                                href="#" aria-expanded="false">
                                                            ...
                                                            <ul class="collapse nav flex-column ms-3"
                                                                id="subMenuSaldo_{{ $item->id }}">
                                                                <li class="nav-item">
                                                                    <a class="nav-link"
                                                                        href="{{ route('saldo_ex_unit_alat', ['id_proyek' => $item->id]) }}">
                                                                        <i
                                                                            class="bi me-2 nav-icon fs-5 bi-cash-stack"></i>
                                                                        <p>EX Unit Alat</p>
                                                                    </a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link"
                                                                        href="{{ route('saldo_ex_panjar_unit_alat', ['id_proyek' => $item->id]) }}">
                                                                        <i
                                                                            class="bi me-2 nav-icon fs-5 bi-cash-stack"></i>
                                                                        <p>EX Panjar Unit Alat</p>
                                                                    </a>
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link"
                                                                        href="{{ route('saldo_ex_panjar_proyek', ['id_proyek' => $item->id]) }}">
                                                                        <i
                                                                            class="bi me-2 nav-icon fs-5 bi-cash-stack"></i>
                                                                        <p>EX Panjar Proyek</p>
                                                                    </a>
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link submenu" data-bs-toggle="collapse"
                                                                data-bs-target="#subMenuLaporan_{{ $item->id }}"
                                                                href="#" aria-expanded="false">
                                                            ...
                                                            <ul class="collapse nav flex-column ms-3"
                                                                id="subMenuLaporan_{{ $item->id }}">
                                                                <li class="nav-item">
                                                                    <a class="nav-link"
                                                                        href="{{ route('laporan.summary', ['id_proyek' => $item->id]) }}">
                                                                        <i
                                                                            class="bi me-2 nav-icon fs-5 bi-newspaper"></i>
                                                                        <p>Summary</p>
                                                                    </a>
                                                                </li>
                        ...
                        <div
                            class="os-scrollbar os-scrollbar-auto-hidden os-scrollbar-horizontal os-scrollbar-unusable">
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.13.3/jquery-ui.min.js" crossorigin="anonymous"
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/admin-lte/3.2.0/js/adminlte.min.js" crossorigin="anonymous"
