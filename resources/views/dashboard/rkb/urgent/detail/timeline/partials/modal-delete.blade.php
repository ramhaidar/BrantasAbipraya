    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content rounded-4">
            ...
            <div class="pt-3 px-3 m-0 d-flex w-100 justify-content-between">
                <h5 class="modal-title w-100 pb-2" id="modalForDeleteLabel">Konfirmasi Hapus Timeline RKB Urgent</h5>
            ...
            <div class="modal-body">
                <p class="p-0 m-0">Apakah Anda yakin ingin menghapus Timeline RKB Urgent ini?</p>
            ...
            <div class="modal-footer d-flex w-100 justify-content-end">
                ...
                <button class="btn btn-danger w-25" id="confirmDeleteButton" type="button">Hapus</button>
            </div>
        </div>
    </div>
</div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function showModalDelete(id) {
                ...
                $('#modalForDelete').modal('show'); // Tampilkan modal
            }
