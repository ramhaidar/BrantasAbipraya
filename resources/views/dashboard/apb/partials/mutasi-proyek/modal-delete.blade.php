    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content rounded-4">
            <div class="pt-3 px-3 m-0 d-flex w-100 justify-content-between">
                <h5 class="modal-title w-100 pb-2" id="modalForDeleteLabel">Konfirmasi Hapus Data APB</h5>
                <button class="btn-close" data-bs-dismiss="modal" type="button" aria-label="Close"></button>
            </div>
            <hr class="p-0 m-0 border border-secondary-subtle border-2 opacity-50">
            <div class="modal-body">
                <p class="p-0 m-0">Apakah Anda yakin ingin menghapus data APB ini?</p>
...
@push('scripts_3')
    <script>
        ...
        function deleteWithForm(id) {
            ...
            form.action = `{{ route('apb.destroy.mutasi', ['id' => ':id']) }}`.replace(':id', id);
