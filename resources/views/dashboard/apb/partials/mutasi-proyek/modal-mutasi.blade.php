    ...
    <script>
        $(document).ready(function() {
            ...
            if (isKoordinatorProyek) {
                ...
                $('#tanggal_mutasi').datepicker('setDate', initialDate);

                // Update placeholder and validation message
                $('#tanggal_mutasi').attr('placeholder',
                    `Tanggal antara ${formatDate(startDate)} - ${formatDate(endDate)}`);
                $('#tanggal_mutasi').closest('div').find('.invalid-feedback').text(
                    `Tanggal harus antara ${formatDate(startDate)} - ${formatDate(endDate)}`);

                // Add custom validation
                $('#tanggal_mutasi').on('change', function() {
                    try {
                ...
                $('#tanggal_mutasi').datepicker('setDate', new Date());
            }
