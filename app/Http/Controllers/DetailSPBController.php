...
class DetailSPBController extends Controller
{
    public function index($id)
    {
        ...
        // Query for main table data - Show all data
        $query = RKB::query()
            ->with(['proyek', 'spbs'])
            ->whereHas('spbs')
        ...
        $TableData = $query->get();
        // Convert collection to LengthAwarePaginator to maintain pagination interface
        ...
        // Get detail RKB data with relationships
        $rkb = RKB::with([
        ...
        return view('dashboard.spb.detail.detail', [
            ...
            'TableData' => $TableData, // Add TableData to view
