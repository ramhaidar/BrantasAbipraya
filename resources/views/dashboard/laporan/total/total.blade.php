                ...
                <div class="ibox-head pe-0 ps-0">
                    <div class="d-flex justify-content-between align-items-center w-100">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            @if (isset($proyek))
                                <a class="btn btn-warning btn-sm btn-hide-text-mobile" href="{{ route('export.lnpb_total') }}?id={{ $proyek->id }}&startDate={{ $startDate }}&endDate={{ $endDate }}">
                                    <i class="fa-solid fa-file-excel"></i> <span class="ms-2">Export</span>
                                </a>
                            @else
                                <a class="btn btn-warning btn-sm btn-hide-text-mobile" href="{{ route('export.lnpb_total') }}?startDate={{ $startDate }}&endDate={{ $endDate }}">
                                    <i class="fa-solid fa-file-excel"></i> <span class="ms-2">Export</span>
                                </a>
                            @endif
