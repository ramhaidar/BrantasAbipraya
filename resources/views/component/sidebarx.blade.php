...
<div class="user-panel ms-0 ps-0 py-2 d-flex collapse-user-panel justify-content-start align-items-center">
    <div class="image me-2">
        <img class="img-circle elevation-2" src="{{ Auth::user()->path_profile ?? 'dist/img/user2-160x160.jpg' }}"
            alt="User Image" style="border-radius: 50%; width: 40px; height: 40px; border: 2pt solid #fff;">
    </div>
    <div class="info">
...
<div class="form-inline mt-0 mx-0">
    <div class="input-group" data-widget="sidebar-search">
        <input class="form-control form-control-sidebar" id="searchProyek" type="search" aria-label="Search"
            placeholder="Search">
                    ...
                    <div class="os-content" style="padding:0 8px;height:100%;width:100%">
                        <nav class="mt-2">
                            <ul class="nav flex-column nav-pills nav-sidebar" data-accordion="false"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="collapse" data-bs-target="#subMenuMasterData"
                                ...
                                <li class="nav-item proyek-item">
                                    <a class="nav-link" data-bs-toggle="collapse"
                                        data-bs-target="#subMenuProyek_{{ $item->id }}" href="#" aria-expanded="false">
                                    ...
                                    <ul class="collapse nav flex-column ms-1" id="subMenuProyek_{{ $item->id }}">
                                        <li class="nav-item">
                                            <a class="nav-link submenu" data-bs-toggle="collapse"
                                                data-bs-target="#subMenuATB_{{ $item->id }}" href="#"
                                                aria-expanded="false">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link submenu" data-bs-toggle="collapse"
                                                data-bs-target="#subMenuAPB_{{ $item->id }}" href="#"
                                                aria-expanded="false">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link submenu" data-bs-toggle="collapse"
                                                data-bs-target="#subMenuSaldo_{{ $item->id }}" href="#"
                                                aria-expanded="false">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link submenu" data-bs-toggle="collapse"
                                                data-bs-target="#subMenuLaporan_{{ $item->id }}" href="#"
                                                aria-expanded="false">
