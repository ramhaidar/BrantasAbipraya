...
<div class="ibox-body ms-0 ps-0">
    <div class="mb-3 d-flex justify-content-end">
        @if (request('selected_tanggal') || request('selected_asal_proyek') || request('selected_kode') || request('selected_supplier') || request('selected_sparepart') || request('selected_merk') || request('selected_part_number') || request('selected_quantity_dikirim') || request('selected_quantity_diterima') || request('selected_satuan') || request('selected_harga') || request('selected_jumlah_harga'))
