                    ...
                    <div class="ibox-head pe-0 ps-0">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            @if ($rkb->is_approved_svp)
                                <button class="btn btn-danger btn-sm" id="cancelApproveSvpButton" data-bs-toggle="modal" data-bs-target="#modalForApproveSvp" data-action="{{ route('evaluasi_rkb_general.detail.approve.svp', $rkb->id) }}" data-message="Apakah Anda yakin ingin membatalkan Approve RKB ini sebagai SVP?">
                            ...
                            @if (!$rkb->is_approved_svp && $rkb->is_approved_vp)
                                <button class="btn btn-primary btn-sm" id="approveSvpButton" data-bs-toggle="modal" data-bs-target="#modalForApproveSvp" data-action="{{ route('evaluasi_rkb_general.detail.approve.svp', $rkb->id) }}" data-message="Apakah Anda yakin ingin Approve RKB ini sebagai SVP?" {{ !$rkb->is_approved_vp ? 'disabled' : '' }}>
