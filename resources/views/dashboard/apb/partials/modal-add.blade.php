<div class="fade modal" id="modalForAdd" aria-hidden="true" aria-labelledby="staticBackdropLabel" tabindex="-1">
    <div class="modal-dialog modal-dialog-scrollable modal-xl modal-dialog-centered">
        <div class="modal-content rounded-4">
            ...
            <form class="w-100 align-items-center flex-column gap-0 overflow-auto need-validation" id="addDataForm" method="POST" action="{{ route('apb.post.store') }}" enctype="multipart/form-data" novalidate>
                @csrf
                        ...
                        <div class="col-12">
                            ...
                            <select class="form-control" id="id_alat" name="id_alat" required>
                                ...
                                @foreach ($alats as $alat)
                                    @if ($alat->MasterDataAlat->jenis_alat == 'Workshop')
                                        <option value="{{ $alat->id }}">WORKSHOP </option>
                                    @else
