                            ...
                            <ul class="nav flex-column nav-pills nav-sidebar" data-accordion="false" data-widget="treeview" role="menu">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="collapse nav flex-column ms-1" id="subMenuMasterData">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('master_data_alat.index') }}">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('master_data_sparepart.index') }}">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('master_data_supplier.index') }}">
