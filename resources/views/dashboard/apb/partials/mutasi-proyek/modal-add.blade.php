...
@push('scripts_3')
    <script>
        $(document).ready(function() {
            ...
            $('#tanggal_add').datepicker('destroy');
            ...
            if (isKoordinatorProyek) {
                ...
                $('#tanggal_add').datepicker('setDate', new Date());
            }
