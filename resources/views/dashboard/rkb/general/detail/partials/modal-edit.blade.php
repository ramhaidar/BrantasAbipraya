    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content rounded-4">
            <div class="pt-3 px-3 m-0 d-flex w-100 justify-content-between">
                <h5 class="modal-title w-100 pb-2" id="modalForEditLabel">Ubah Rencana Kebutuhan Barang</h1>
            ...
            <form class="needs-validation" id="editRKBGeneralForm" novalidate method="POST">
                ...
                <div class="modal-footer d-flex w-100 justify-content-end">
                    ...
                    <button class="btn btn-primary w-25" id="update-rkbgeneral" type="submit">Simpan</button>
                </div>
            </form>
        </div>
    </div>
        ...
        function fillFormEditDetailRKB(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#editRKBGeneralForm').attr('action', updateUrl);
