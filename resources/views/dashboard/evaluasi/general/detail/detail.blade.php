...
@section('title', 'Evaluasi Detail RKB General - ' . $rkb->proyek->nama)
                ...
                <div class="ibox">
                    <div class="ibox-head pe-0 ps-0">
                        <div class="ibox-title d-flex align-items-center gap-3">
                            <a class="btn btn-outline-primary btn-sm btn-hide-text-mobile" href="{{ route('evaluasi_rkb_general.index') }}">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a class="btn btn-warning btn-sm btn-hide-text-mobile {{ $rkb->is_approved_svp ? '' : 'disabled' }}" href="{{ route('export.evaluasi_rkb_general', ['id' => $rkb->id]) }}">
